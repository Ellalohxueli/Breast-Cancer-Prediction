...
import { FaRegBell, FaRegUser, FaPhone, FaEnvelope, FaMapMarkerAlt, FaFacebookF, FaTwitter, FaInstagram, FaLinkedinIn, FaUsers, FaComments } from "react-icons/fa";
    ...
    return (
        <div id="top" className={`min-h-screen bg-gray-50 ${poppins.className}`}>
            ...
            {showAllEventsModal && (
                <>
                    {/* Backdrop with blur effect */}
                    <div className="fixed inset-0 z-40 backdrop-blur-sm" onClick={() => setShowAllEventsModal(false)} />
