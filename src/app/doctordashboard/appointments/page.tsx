                    ...
                    <div className="grid grid-cols-[80px_1fr] divide-x divide-gray-200">
                        ...
                        <div className="space-y-0">
                            {hours.map((hour) => (
                                <div 
                                    key={hour} 
                                    className={`h-20 flex items-center justify-end pr-4 text-xs font-medium ${
                                ...
                                <div key={dayIndex} className="relative">
                                    {hours.map((hour) => (
                                        ...
                                        >
                                            {/* Example appointment */}
                                            {hour === 10 && dayIndex === 3 && (
                                                <div className={`absolute inset-x-1 top-[200px] h-20 rounded-lg px-2 py-1 ${
                                                    isDarkMode
                        ...
                        <div className="relative">
                            ...
                            {hours.map((hour) => (
                                ...
                                >
                                    {/* Example appointment */}
                                    {hour === 10 && (
                                        <div className={`absolute inset-x-1 h-20 rounded-lg px-2 py-1 ${
                                            isDarkMode
                                                ? 'bg-pink-500/20 text-pink-300'
                                                : 'bg-pink-100 text-pink-800'
                                        }`}>
                                ...
                                <div className="flex items-center justify-between mb-4">
                                    ...
                                    <div className="flex items-center space-x-2">
                                        <button 
                                            ...
                                            className={`px-4 py-2 rounded-lg text-sm font-medium ${
                                                viewType === 'month'
                                                    ? isDarkMode ? 'bg-pink-500 text-white' : 'bg-pink-600 text-white'
                                                    : isDarkMode ? 'bg-gray-700 text-white' : 'bg-gray-100 text-gray-700'
                                            }`}
                                        >
                                            Month
                                    ...
                                    <div className="grid grid-cols-7 gap-2">
                                        {Array.from({ length: 35 }, (_, i) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    <div className={`font-medium text-sm mb-1 w-7 h-7 flex items-center justify-center rounded-full ${
                                                        isToday(day + 1) && isCurrentMonth
                                                            ? isDarkMode
                                                                ? 'bg-pink-500 text-white'
                                                                : 'bg-pink-600 text-white'
                            ...
                            <div className={`space-y-0 divide-y ${isDarkMode ? 'divide-gray-600' : 'divide-gray-200'}`}>
                                    ...
                                    <div className={`p-3 rounded-lg ${isDarkMode ? 'bg-gray-700/50' : 'bg-gray-50'}`}>
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <div className="grid grid-cols-2 gap-4">
                                                <div>
                                                    <label className={`block text-base font-medium mb-1.5 ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                                                        Start Date
                                                    </label>
                                                    <input 
                                                        type="date" 
                                ...
                                <div className="py-2">
                                    <div className={`p-3 rounded-lg ${isDarkMode ? 'bg-gray-700/50' : 'bg-gray-50'}`}>
                                        ...
                                        <p className={`text-sm mb-3 ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                                            Add dates or custom range to exclude from your availability.<br />
                                        ...
                                        {exclusionType === 'single' ? (
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center">
                                                    <div className={`flex flex-1 items-center rounded-lg border ${
                                                        isDarkMode 
                                                            ? 'bg-gray-700 border-gray-600' 
                        ...
                        <div className="border-t border-gray-200">
                            <div className="flex justify-end space-x-4 p-4">
                                {submitMessage.message && (
                                    <div className={`px-4 py-2 rounded-lg mr-auto ${
