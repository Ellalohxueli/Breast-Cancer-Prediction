...
export default function AdminDashboard() {
    ...
    const getStatusStyle = (status: string) => {
        switch (status) {
            case "Completed":
                return isDarkMode ? "bg-green-400/10 text-green-400" : "bg-green-100 text-green-700";
            case "Ongoing":
                return isDarkMode ? "bg-blue-400/10 text-blue-400" : "bg-blue-100 text-blue-700";
            case "Booked":
                return isDarkMode ? "bg-yellow-400/10 text-yellow-400" : "bg-yellow-100 text-yellow-700";
            case "Cancelled":
                return isDarkMode ? "bg-red-400/10 text-red-400" : "bg-red-100 text-red-700";
            default:
                return isDarkMode ? "bg-gray-400/10 text-gray-400" : "bg-gray-100 text-gray-700";
        }
    };
            ...
            <div className="flex-1 flex flex-col ml-64">
                ...
                <div className={`px-8 py-4 flex items-center justify-between fixed top-0 right-0 left-64 z-10 ${isDarkMode ? "bg-gray-900" : "bg-gray-50"} shadow-sm`}>
                    ...
                    <div className="flex-shrink-0">
                        <h1 className={`text-2xl font-bold ${isDarkMode ? "text-white" : "text-black"}`}>Welcome back to PinkPath!</h1>
                    ...
                    <div className="px-6">
                        ...
                        <div className="grid grid-cols-12 gap-6">
                            ...
                            <div className="col-span-7 space-y-4">
                                <div className="flex gap-6">
                                    {/* Total Doctors Card */}
                                    <div
                                        className={`w-[320px] h-[140px] p-6 rounded-lg ${
                                            isDarkMode ? "bg-gradient-to-br from-blue-900/40 to-blue-800/20" : "bg-gradient-to-br from-blue-50 to-blue-100/50"
                                        } shadow-lg flex items-center justify-between relative overflow-hidden`}
                                    >
                                        <div className="absolute inset-0 opacity-10">
                                            <div className={`w-48 h-48 rounded-full ${isDarkMode ? "bg-blue-600/30" : "bg-blue-200/50"} absolute -top-20 -right-20`}></div>
                                            <div className={`w-32 h-32 rounded-full ${isDarkMode ? "bg-blue-600/30" : "bg-blue-200/50"} absolute -bottom-10 -left-10`}></div>
                                        </div>
                                        <div className="flex items-center space-x-4 relative z-10">
                                            <div
                                                className={`w-12 h-12 rounded-lg flex items-center justify-center ${
                                                    isDarkMode ? "bg-gradient-to-br from-blue-600 to-blue-800" : "bg-gradient-to-br from-blue-400 to-blue-600"
                                                } shadow-lg`}
                                            >
                                                <FaUserDoctor className="w-6 h-6 text-white" />
                                            </div>
                                            <div>
                                                <p className={`text-3xl font-bold ${isDarkMode ? "text-white" : "text-gray-900"}`}>{doctors.length}</p>
                                                <p className={`text-base font-medium mt-1 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>Total Doctors</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div
                                        className={`w-[320px] h-[140px] p-6 rounded-lg ${
                                            isDarkMode ? "bg-gradient-to-br from-amber-900/40 to-orange-800/20" : "bg-gradient-to-br from-amber-50 to-orange-100/50"
                                        } shadow-lg flex items-center justify-between relative overflow-hidden`}
                                    >
                                        <div className="absolute inset-0 opacity-10">
                                            <div className={`w-48 h-48 rounded-full ${isDarkMode ? "bg-amber-500/30" : "bg-amber-200/50"} absolute -top-20 -right-20`}></div>
                                            <div className={`w-32 h-32 rounded-full ${isDarkMode ? "bg-orange-500/30" : "bg-orange-200/50"} absolute -bottom-10 -left-10`}></div>
                                        </div>
                                        <div className="flex items-center space-x-4 relative z-10">
                                            <div
                                                className={`w-12 h-12 rounded-lg flex items-center justify-center ${
                                                    isDarkMode ? "bg-gradient-to-br from-amber-600 to-orange-800" : "bg-gradient-to-br from-amber-400 to-orange-600"
                                                } shadow-lg`}
                                            >
                                                <FiUsers className="w-6 h-6 text-white" />
                                            </div>
                                            <div>
                                                <p className={`text-3xl font-bold ${isDarkMode ? "text-white" : "text-gray-900"}`}>{userCount}</p>
                                                <p className={`text-base font-medium mt-1 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>Total Users</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className={`p-6 rounded-lg ${isDarkMode ? "bg-gray-800" : "bg-white"} shadow-lg h-[300px]`}>
                                    <h3 className={`text-xl font-semibold mb-2 ${isDarkMode ? "text-white" : "text-black"}`}>Upcoming Appointments</h3>
                                    <div
                                                    ...
                                                    [...appointments]
                                                        ...
                                                        .map((appointment) => (
                                                            <tr key={appointment._id} className={isDarkMode ? "text-gray-300" : "text-gray-700"}>
                                                                ...
                                                                <td className="py-2 w-[20%]">{formatTime(appointment.timeSlot.startTime)}</td>
                                                                <td className="py-2 w-[20%]">
                                                                    <span
                                                                        className={`inline-block w-20 text-center px-2 py-1 rounded-full text-xs font-medium ${getStatusStyle(
                                                                            appointment.status
                                                                        )}`}
                                                                    >
                                                                        {appointment.status}
                            ...
                            <div className="col-span-5">
                                <div className={`p-6 rounded-lg ${isDarkMode ? "bg-gray-800" : "bg-white"} shadow-lg h-[424px]`}>
                                    <h3 className={`text-xl font-semibold mb-4 ${isDarkMode ? "text-white" : "text-black"}`}>Doctors List</h3>
                                    <div
                                        className={`flex items-center px-4 py-2 rounded-lg mb-2 ${
                                            isDarkMode ? "bg-gray-700/70 text-gray-300" : "bg-gray-200/70 text-gray-700"
                                        } font-medium`}
                                    ...
                                    <div className="space-y-2 h-[300px] overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-transparent">
                                        {isLoading ? (
                                            <div className={`flex justify-center items-center h-full ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>Loading doctors...</div>
                                        ) : doctors.length === 0 ? (
                                            <div className={`flex justify-center items-center h-full ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>No doctors found</div>
                                        ) : (
                                            doctors.map((doctor) => (
                                                <div
                                                    key={doctor._id}
                                                ...
                                                >
                                                    <div className="flex items-center space-x-3 flex-1">
                                                        ...
                                                        <span className={isDarkMode ? "text-gray-300" : "text-gray-700"}>{doctor.name}</span>
                                                    </div>
                                                    <div className="flex items-center space-x-2 w-[100px]">
                                                        ...
                                                        <span className={`text-sm ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>{doctor.status}</span>
                                                    </div>
                                                </div>
                                            ))
                                        )}
                        ...
                        <div className="grid grid-cols-1 gap-6 mt-6">
                            <div className={`p-6 rounded-lg ${isDarkMode ? "bg-gray-800" : "bg-white"} shadow-lg`}>
                                <h3 className={`text-xl font-semibold mb-4 ${isDarkMode ? "text-white" : "text-black"}`}>Appointment Statistics</h3>
                                    ...
                                    <div className="flex-1 flex items-end space-x-6 pl-12 pr-4 relative">
                                        ...
                                        <div className="absolute left-0 inset-y-0 w-10 flex flex-col justify-between">
                                            {[250, 200, 150, 100, 50, 0].map((value) => (
                                                <div key={value} className="flex items-center">
                                                    <span className={`text-xs ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>{value}</span>
                                                </div>
                                            ))}
                                        </div>
                                        ...
                                        {(() => {
                                            ...
                                            appointments.forEach((appointment) => {
                                                ...
                                                if (appointmentDate.getFullYear() === currentYear && appointment.status !== "Cancelled" && appointment.status !== "Rescheduled") {
                                                ...
                                                <div key={index} className="flex flex-col items-center flex-1">
                                                    <div className="relative w-full flex justify-center">
                                                        <div
                                                            ...
                                                            } rounded-t-lg relative group hover:opacity-80 transition-opacity cursor-pointer`}
                                                        ...
                                                        >
                                                            ...
                                                            <div className={`absolute inset-0 ${isDarkMode ? "bg-purple-400/40" : "bg-purple-500/40"} rounded-t-lg`}></div>
                                                        </div>
                                                    </div>
                                                    <span className={`mt-2 text-sm ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>{data.month}</span>
                                                </div>
                                            ));
                                        })()}
                                    </div>
