...
const DoctorsPage = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        } else if (newDoctor.phone.length < 12) {
            // +60 + 9 digits
    ...
    const handleEditInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => {
        ...
        if (name === "phone") {
            ...
            const formattedValue = value
                ...
                .replace(/\b(mon|tue|wed|thu|fri|sat|sun)\b/gi, (day) => day.charAt(0).toUpperCase() + day.slice(1).toLowerCase())
    ...
    return (
        <div className={`flex min-h-screen ${isDarkMode ? "bg-gray-900" : "bg-gray-50"}`}>
            {/* Sidebar - Fixed */}
            <div
                className={`w-64 h-screen fixed left-0 top-0 ${isDarkMode ? "bg-gray-900" : "bg-white"} shadow-lg transition-all duration-300 ${
            ...
            <div className="flex-1 flex flex-col ml-64">
                ...
                <div className={`px-8 py-4 flex items-center justify-between fixed top-0 right-0 left-64 z-10 ${isDarkMode ? "bg-gray-900" : "bg-gray-50"} shadow-sm`}>
                    ...
                    <div className="flex-shrink-0">
                        <h1 className={`text-2xl font-bold ${isDarkMode ? "text-white" : "text-black"}`}>Manage Doctor</h1>
                ...
                <div className="flex-1 p-4 pt-28">
                    ...
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <button
                            ...
                            className={`${isDarkMode ? "bg-gray-800/80 hover:bg-gray-700/90" : "bg-gray-500/10 hover:bg-gray-500/20"} text-${
                                isDarkMode ? "gray-200" : "gray-700"
                                        ...
                                        <tr key={doctor._id} className={`${isDarkMode ? "hover:bg-gray-700" : "hover:bg-gray-50"}`}>
                                            <td className="w-3/12 px-6 py-4 max-w-0">
                                                <div className="flex items-center space-x-4">
                                                    <div className="h-12 w-12 flex-shrink-0 relative">
                                                        {doctor.image ? (
                                                            <Image src={doctor.image} alt={`${doctor.name}'s profile`} fill className="rounded-full object-cover" />
                                                        ) : (
                                                            <div className="h-12 w-12 rounded-full bg-pink-200 flex items-center justify-center">
                                                                <span className="text-lg font-medium text-pink-800">{doctor.name.charAt(0)}</span>
                                                            </div>
                                                        )}
                                                    </div>
                                            ...
                                            <td className="w-3/12 px-6 py-4">
                                                <div className="text-sm space-y-1">
                                                    ...
                                                    <div className={`${isDarkMode ? "text-gray-400" : "text-gray-500"}`}>{doctor.phone}</div>
                                                </div>
                                            </td>
                                            <td className="w-2/12 px-6 py-4">
                                                <span
                                                    className={`inline-block px-3 py-1 rounded-full text-sm truncate max-w-full ${
                                            ...
                                            <td className="w-2/12 px-6 py-4">
                                                <div className="text-sm truncate">{doctor.operatingHours || "Not specified"}</div>
                                            </td>
                                            <td className="w-2/12 px-6 py-4">
                    ...
                    {isAddDoctorModalOpen && (
                        <div className="fixed inset-0 backdrop-blur-sm bg-white/30 dark:bg-gray-900/30 flex items-center justify-center z-50">
                            ...
                            >
                                ...
                                <h2 className={`text-xl font-bold mb-6 ${isDarkMode ? "text-white" : "text-gray-800"}`}>Register New Doctor</h2>
                                ...
                                <form onSubmit={handleSubmit} className="space-y-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full px-3 py-2 rounded-lg border ${
                                                ...
                                                isDarkMode ? "placeholder-gray-400 caret-white" : "placeholder-gray-500 caret-gray-700"
                                            }`}
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            <div className={`absolute left-3 top-1/2 transform -translate-y-1/2 ${isDarkMode ? "text-white" : "text-gray-700"}`}>+60</div>
                                            <input
                                                type="tel"
                                                name="phone"
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            minLength={8}
                                        />
                                        <p className={`text-xs mt-1 ${isDarkMode ? "text-gray-400" : "text-gray-500"}`}>Password must be at least 8 characters long</p>
                    ...
                    {deleteConfirmationModal && (
                        <div className="fixed inset-0 backdrop-blur-sm bg-white/30 dark:bg-gray-900/30 flex items-center justify-center z-50">
                            ...
                            >
                                <h2 className={`text-xl font-bold mb-4 ${isDarkMode ? "text-white" : "text-gray-800"}`}>Confirm Delete</h2>
                    ...
                    {isEditDoctorModalOpen && selectedDoctor && (
                        <div className="fixed inset-0 backdrop-blur-sm bg-white/30 dark:bg-gray-900/30 flex items-center justify-center z-50">
                            ...
                            >
                                ...
                                <h2 className={`text-xl font-bold mb-6 ${isDarkMode ? "text-white" : "text-gray-800"}`}>Edit Doctor Information</h2>

                                <form onSubmit={handleEditSubmit} className="space-y-4">
                                    {/* Photo Upload */}
                                    <div>
                                        <label className={`block text-sm font-medium mb-1 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>Profile Photo</label>
                                        <div className="flex items-center space-x-4">
                                            <div className="relative w-24 h-24 rounded-full overflow-hidden border-2 border-pink-500">
                                                {imagePreview ? (
                                                    <Image src={imagePreview} alt="Doctor profile" fill className="object-cover" />
                                                ) : (
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className={`text-xs mt-1 ${isDarkMode ? "text-gray-400" : "text-gray-500"}`}>Recommended: Square image, max 5MB</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                type="tel"
                                                name="phone"
                                                value={String(editFormData.phone).startsWith("60") ? String(editFormData.phone).slice(2) : String(editFormData.phone)}
                                                onChange={handleEditInputChange}
                                                className={`w-full pl-12 pr-3 py-2 rounded-lg border ${
                                                    errors.phone ? "border-red-500 ring-1 ring-red-500" : isDarkMode ? "bg-gray-700 border-gray-600" : "bg-white border-gray-300"
                                    ...
                                    <div>
                                        <label className={`block text-sm font-medium mb-1 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>Operating Hours</label>
                                        <input
                                            type="text"
                                            name="operatingHours"
                    ...
                    {isViewDoctorModalOpen && viewDoctor && (
                        <div className="fixed inset-0 backdrop-blur-sm bg-white/30 dark:bg-gray-900/30 flex items-center justify-center z-50">
                            <div
                                className={`${isDarkMode ? "bg-gray-800/95" : "bg-white/95"} rounded-lg p-6 w-full max-w-2xl relative shadow-xl backdrop-blur-sm border ${
                                    isDarkMode ? "border-gray-700" : "border-gray-200"
                                } max-h-[90vh] overflow-y-auto`}
                            >
                                <button
                                ...
                                <h2 className={`text-xl font-bold mb-6 ${isDarkMode ? "text-white" : "text-gray-800"}`}>Doctor Details</h2>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    ...
                                    <div className="md:col-span-1">
                                        <div className="relative w-full aspect-square rounded-lg overflow-hidden border-2 border-pink-500">
                                            {viewDoctor.image ? (
                                                <Image src={viewDoctor.image} alt={`${viewDoctor.name}'s profile`} fill className="object-cover" />
                                            ) : (
                                                <div className={`w-full h-full flex items-center justify-center ${isDarkMode ? "bg-gray-700" : "bg-gray-100"}`}>
                                    ...
                                    <div className="md:col-span-2 space-y-4">
                                        <div>
                                            <h3 className={`text-lg font-semibold ${isDarkMode ? "text-white" : "text-gray-800"}`}>{viewDoctor.name}</h3>
                                            <p className={`${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>{viewDoctor.specialization || "No specialization specified"}</p>
                                        </div>

                                        <div className="grid grid-cols-1 gap-4">
                                            <div>
                                                <label className={`block text-sm font-medium ${isDarkMode ? "text-gray-300" : "text-gray-600"}`}>Email</label>
                                                <p className={`${isDarkMode ? "text-white" : "text-gray-800"}`}>{viewDoctor.email}</p>
                                            </div>

                                            <div>
                                                <label className={`block text-sm font-medium ${isDarkMode ? "text-gray-300" : "text-gray-600"}`}>Phone Number</label>
                                                <p className={`${isDarkMode ? "text-white" : "text-gray-800"}`}>{viewDoctor.phone}</p>
                                            </div>

                                            <div>
                                                <label className={`block text-sm font-medium ${isDarkMode ? "text-gray-300" : "text-gray-600"}`}>Operating Hours</label>
                                                <p className={`${isDarkMode ? "text-white" : "text-gray-800"}`}>{viewDoctor.operatingHours || "Not specified"}</p>
                                            </div>

                                            <div>
                                                <label className={`block text-sm font-medium ${isDarkMode ? "text-gray-300" : "text-gray-600"}`}>Bio</label>
                                                <p className={`${isDarkMode ? "text-white" : "text-gray-800"} whitespace-pre-wrap`}>{viewDoctor.bio || "No bio available"}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    {showInfoDropdown && (
                        <div
                            className={`fixed ml-2 w-48 rounded-md shadow-lg ${isDarkMode ? "bg-gray-700" : "bg-white"} py-1 z-[9999]`}
                            style={{
