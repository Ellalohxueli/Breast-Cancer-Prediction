...
export default function ManageResources() {
        ...
        { href: "/admindashboard/patients", icon: <FiUsers className="w-5 h-5 mr-4" />, text: "Patients" },
        {
            ...
            component: (
                <div className="relative" style={{ position: "relative", zIndex: 60 }}>
                    ...
                    {showInfoDropdown && (
                        <div
                            className={`absolute left-full top-0 ml-2 w-48 rounded-md shadow-lg ${isDarkMode ? "bg-gray-700" : "bg-white"} py-1`}
                            style={{
                                position: "absolute",
                                zIndex: 999,
                                left: "100%",
        ...
        try {
            ...
            if (resourceFormData.category === "Events & Support Groups") {
                ...
                updateData = {
                    ...
                    eventDate: resourceFormData.eventDate ? new Date(resourceFormData.eventDate).toISOString() : undefined,
    ...
    return (
        <div className={`flex min-h-screen ${isDarkMode ? "bg-gray-900" : "bg-gray-50"}`}>
            {/* Sidebar - Fixed */}
            <div
                className={`w-64 shadow-lg flex flex-col justify-between fixed left-0 top-0 h-screen transition-all duration-300 ${isDarkMode ? "bg-gray-800" : "bg-white"} ${
                    isAnyModalOpen() ? "backdrop-blur-sm bg-opacity-50" : ""
                } z-[40]`}
            >
                <div>
                    <div className="p-6">
            ...
            <div className="flex-1 flex flex-col ml-64">
                {/* Top Menu Bar - Fixed */}
                <div className={`px-8 py-4 flex items-center justify-between fixed top-0 right-0 left-64 z-[45] ${isDarkMode ? "bg-gray-900" : "bg-gray-50"} shadow-sm`}>
                    {/* Welcome Message */}
                    <div className="flex-shrink-0">
                        <h1 className={`text-2xl font-bold ${isDarkMode ? "text-white" : "text-black"}`}>Manage Resources</h1>
                ...
                <div className="flex-1 p-4 pt-28 overflow-y-auto z-[30]">
                    {" "}
                    ...
                    <div className="px-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {isLoading ? (
                                // Loading skeleton
                                [...Array(6)].map((_, index) => (
                                    <div key={index} className={`rounded-lg border ${isDarkMode ? "bg-gray-700 border-gray-600" : "bg-white border-gray-200"} animate-pulse`}>
                                ...
                                <div className={`col-span-3 text-center py-8 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
                                    <p className="text-lg">{searchQuery ? "No resources found matching your search" : "No resources found"}</p>
                                </div>
                            ) : (
                                // Resources list
                                    ...
                                    >
                                        {resource.category === "Events & Support Groups" ? (
                                            ...
                                            <div className="p-4">
                                                ...
                                                <div className="flex justify-between items-start mb-4">
                                                    ...
                                                    <span
                                                        className={`px-3 py-1 text-sm rounded-full capitalize ${
                                                            isDarkMode ? "bg-blue-400/10 text-blue-400" : "bg-blue-100 text-blue-800"
                                                        }`}
                                                    >
                                                    ...
                                                    {/* Date Display */}
                                                    {resource.eventDate && (
                                                        <div className={`text-center px-3 py-1 rounded-lg ${isDarkMode ? "bg-gray-600" : "bg-gray-100"}`}>
                                                ...
                                                {/* Title */}
                                                <h3 className={`font-semibold text-lg mb-2 ${isDarkMode ? "text-white" : "text-gray-900"}`}>{resource.title}</h3>

                                                {/* Description */}
                                                <p className={`text-sm mb-4 line-clamp-3 ${isDarkMode ? "text-gray-300" : "text-gray-600"}`}>{resource.shortDescription}</p>
                                                ...
                                                <div className="flex items-center justify-between pt-2 border-t border-gray-200 dark:border-gray-600">
                                                    ...
                                                    <div className={`flex items-center ${isDarkMode ? "text-gray-300" : "text-gray-600"}`}>
                                                        ...
                                                        <span className="text-sm">
                                                            {resource.eventTime
                                                                ? new Date(`2000/01/01 ${resource.eventTime}`).toLocaleTimeString("en-US", {
                                                                      hour: "numeric",
                                                                      minute: "2-digit",
                                                                      hour12: true,
                                                                  })
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        <button
                                                            ...
                                                            className={`p-2 rounded-lg transition-colors ${
                                                                isDarkMode ? "hover:bg-gray-600 text-blue-400" : "hover:bg-gray-100 text-blue-600"
                                                            }`}
                                                        >
                                            ...
                                            <>
                                                ...
                                                <div className="aspect-video relative bg-gray-100 dark:bg-gray-800">
                                                    <Image src={resource.featuredImage || "/placeholder-image.jpg"} alt={resource.title} fill className="object-cover" />
                                                </div>
                                                ...
                                                <div className="p-4 flex flex-col h-[160px]">
                                                    ...
                                                    <div className="flex justify-between items-start mb-2 min-h-[48px]">
                                                        <h3 className={`font-semibold ${isDarkMode ? "text-white" : "text-gray-900"} line-clamp-2`}>{resource.title}</h3>
                        ...
                        {/* Pagination Controls */}
                        <div className={`mt-8 flex items-center justify-between px-4 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <button
                                    ...
                                    className={`p-2 rounded-lg border ${isDarkMode ? "border-gray-600 hover:bg-gray-700" : "border-gray-200 hover:bg-gray-50"} ${
            ...
            {isResourceModalOpen && (
                <div className="fixed inset-0 backdrop-blur-sm bg-black/30 flex items-center justify-center z-50">
                    <div
                        className={`${isDarkMode ? "bg-gray-800/95" : "bg-white/95"} rounded-lg p-6 w-full max-w-4xl relative shadow-xl backdrop-blur-sm border ${
                            isDarkMode ? "border-gray-700" : "border-gray-200"
                        } max-h-[90vh] overflow-y-auto`}
                    >
                        {/* Modal Header */}
                        <div className="flex justify-between items-center mb-6">
                            <h2 className={`text-2xl font-semibold ${isDarkMode ? "text-white" : "text-gray-900"}`}>{isEditMode ? "Edit Resource" : "Add New Resource"}</h2>
                            <button onClick={handleCloseModal} className={`p-2 rounded-lg ${isDarkMode ? "hover:bg-gray-700 text-gray-400" : "hover:bg-gray-100 text-gray-600"}`}>
                        ...
                        <form onSubmit={isEditMode ? handleUpdateResource : handleSubmit} className="space-y-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-4 py-2 rounded-lg border ${errors.title ? "border-red-500" : isDarkMode ? "border-gray-600" : "border-gray-300"} ${
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className={`w-full px-4 py-2 rounded-lg border ${errors.category ? "border-red-500" : isDarkMode ? "border-gray-600" : "border-gray-300"} ${
                                        isDarkMode ? "bg-gray-700 text-white" : "bg-white text-gray-900"
                                    } focus:ring-2 focus:ring-pink-500`}
                                >
                            ...
                            {resourceFormData.category === "Events & Support Groups" ? (
                                <>
                                    {/* Event Category */}
                                    <div>
                                        <label className={`block text-sm font-medium mb-2 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>Event Category *</label>
                                        <select
                                            value={resourceFormData.eventCategory}
                                            onChange={(e) => handleInputChange("eventCategory", e.target.value as EventCategory)}
                                            className={`w-full px-4 py-2 rounded-lg border ${
                                                errors.eventCategory ? "border-red-500" : isDarkMode ? "bg-gray-700 border-gray-600" : "bg-white border-gray-300"
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            <label className={`block text-sm font-medium mb-2 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>Event Date *</label>
                                            <input
                                                type="date"
                                                ...
                                                className={`w-full px-4 py-2 rounded-lg border ${
                                                    errors.eventDate ? "border-red-500" : isDarkMode ? "bg-gray-700 border-gray-600" : "bg-white border-gray-300"
                                                } ${isDarkMode ? "text-white" : "text-gray-900"}`}
                                            />
                                            {errors.eventDate && <p className="mt-1 text-sm text-red-500">{errors.eventDate}</p>}
                                        </div>
                                        <div>
                                            <label className={`block text-sm font-medium mb-2 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>Event Time *</label>
                                            <input
                                                type="time"
                                                value={resourceFormData.eventTime}
                                                onChange={(e) => handleInputChange("eventTime", e.target.value)}
                                                className={`w-full px-4 py-2 rounded-lg border ${
                                                    errors.eventTime ? "border-red-500" : isDarkMode ? "bg-gray-700 border-gray-600" : "bg-white border-gray-300"
                                                } ${isDarkMode ? "text-white" : "text-gray-900"}`}
                                            />
                                            {errors.eventTime && <p className="mt-1 text-sm text-red-500">{errors.eventTime}</p>}
                                        </div>
                                    </div>

                                    {/* Short Description */}
                                    <div>
                                        <label className={`block text-sm font-medium mb-2 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>Short Description *</label>
                                        <textarea
                                            value={resourceFormData.shortDescription}
                                            onChange={(e) => handleInputChange("shortDescription", e.target.value)}
                                            rows={4}
                                            className={`w-full px-4 py-2 rounded-lg border ${
                                                errors.shortDescription ? "border-red-500" : isDarkMode ? "bg-gray-700 border-gray-600" : "bg-white border-gray-300"
                                            } ${isDarkMode ? "text-white" : "text-gray-900"}`}
                                ...
                                <>
                                    {/* Content Editor */}
                                    <div>
                                        <label className={`block text-sm font-medium mb-2 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>Content *</label>
                                        <div className={`border rounded-lg ${isDarkMode ? "border-gray-600" : "border-gray-300"}`}>
                                            {/* Formatting Toolbar */}
                                            <div className={`flex items-center gap-1 p-2 border-b ${isDarkMode ? "border-gray-600 bg-gray-700" : "border-gray-200 bg-gray-50"}`}>
                                                {/* Text Formatting */}
                                                <div className="flex items-center gap-1 pr-2 border-r border-gray-300 dark:border-gray-600">
                                                    <button
                                                        ...
                                                        className={`p-2 rounded hover:bg-gray-200 dark:hover:bg-gray-600 ${isDarkMode ? "text-gray-200" : "text-gray-700"}`}
                                                    >
                                            ...
                                            <textarea
                                                ...
                                                rows={8}
                                                className={`w-full px-4 py-2 ${isDarkMode ? "bg-gray-700 text-white" : "bg-white text-gray-900"} focus:outline-none`}
                                    ...
                                    {/* Featured Image */}
                                    <div>
                                        <label className={`block text-sm font-medium mb-2 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>Featured Image *</label>
                                        <div
                                            className={`border-2 border-dashed rounded-lg p-4 ${
                                                errors.featuredImage ? "border-red-500" : isDarkMode ? "border-gray-600" : "border-gray-300"
                                            }`}
                                        >
                                            {resourceFormData.featuredImage ? (
                                                <div className="relative aspect-video">
                                                    <Image src={resourceFormData.featuredImage} alt="Featured image preview" fill className="object-cover rounded-lg" />
                                                    <button
                                                        type="button"
                                                ...
                                                <div className="text-center">
                                                    ...
                                                    <label
                                                        ...
                                                        className={`cursor-pointer inline-flex flex-col items-center ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}
                                                    >
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            <label className={`block text-sm font-medium mb-2 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>Publication Date</label>
                                            <input
                                                type="date"
                                    ...
                                    <div className="space-y-4">
                                        <h3 className={`text-lg font-medium ${isDarkMode ? "text-white" : "text-gray-900"}`}>SEO Metadata *</h3>
                                        <div>
                                            <label className={`block text-sm font-medium mb-2 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>Meta Title *</label>
                                            <input
                                                type="text"
                                                value={resourceFormData.seoMetadata.title}
                                                onChange={(e) => handleInputChange("seoMetadata", e.target.value, "title")}
                                                className={`w-full px-4 py-2 rounded-lg border ${
                                                    errors.seoMetadata?.title ? "border-red-500" : isDarkMode ? "border-gray-600" : "border-gray-300"
                                                } ${isDarkMode ? "bg-gray-700 text-white" : "bg-white text-gray-900"} focus:ring-2 focus:ring-pink-500`}
                                                placeholder="SEO title"
                                            />
                                            {errors.seoMetadata?.title && <p className="mt-1 text-sm text-red-500">{errors.seoMetadata.title}</p>}
                                        </div>
                                        <div>
                                            <label className={`block text-sm font-medium mb-2 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>Meta Description *</label>
                                            <textarea
                                                value={resourceFormData.seoMetadata.description}
                                                onChange={(e) => handleInputChange("seoMetadata", e.target.value, "description")}
                                                rows={3}
                                                className={`w-full px-4 py-2 rounded-lg border ${
                                                    errors.seoMetadata?.description ? "border-red-500" : isDarkMode ? "border-gray-600" : "border-gray-300"
                                                } ${isDarkMode ? "bg-gray-700 text-white" : "bg-white text-gray-900"} focus:ring-2 focus:ring-pink-500`}
                                                placeholder="SEO description"
                                            />
                                            {errors.seoMetadata?.description && <p className="mt-1 text-sm text-red-500">{errors.seoMetadata.description}</p>}
                                        </div>
                                        <div>
                                            <label className={`block text-sm font-medium mb-2 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>Keywords *</label>
                                            <input
                                                type="text"
                                                value={resourceFormData.seoMetadata.keywords}
                                                onChange={(e) => handleInputChange("seoMetadata", e.target.value, "keywords")}
                                                className={`w-full px-4 py-2 rounded-lg border ${
                                                    errors.seoMetadata?.keywords ? "border-red-500" : isDarkMode ? "border-gray-600" : "border-gray-300"
                                                } ${isDarkMode ? "bg-gray-700 text-white" : "bg-white text-gray-900"} focus:ring-2 focus:ring-pink-500`}
                                                placeholder="Comma-separated keywords"
                                            />
                                            {errors.seoMetadata?.keywords && <p className="mt-1 text-sm text-red-500">{errors.seoMetadata.keywords}</p>}
                                        </div>
                                    </div>
                                </>
                            )}
            ...
            {successMessage && (
                <div className="fixed top-4 right-4 bg-green-500 text-white px-6 py-3 rounded-lg shadow-lg z-50">
                    {successMessage === "add" ? "Resource successfully added!" : successMessage === "delete" ? "Resource deleted successfully" : "Resource updated successfully"}
                </div>
            )}
            ...
            {isPreviewModalOpen && previewResource && (
                <div className="fixed inset-0 backdrop-blur-sm bg-black/30 flex items-center justify-center z-50">
                    ...
                    >
                        ...
                        <div className="flex justify-between items-center mb-6">
                            <div>
                                <span className={`px-2 py-1 text-xs rounded-full ${isDarkMode ? "bg-pink-400/10 text-pink-400" : "bg-pink-100 text-pink-800"}`}>
                        ...
                        <div className="relative h-[300px] mb-6 rounded-lg overflow-hidden">
                            <Image src={previewResource.featuredImage || "/placeholder-image.jpg"} alt={previewResource.title} fill className="object-cover" />
                        </div>

                        {/* Title */}
                        <h1 className={`text-3xl font-bold mb-4 ${isDarkMode ? "text-white" : "text-gray-900"}`}>{previewResource.title}</h1>
                        ...
                        {previewResource.category === "Events & Support Groups" ? (
                            ...
                            <div className="space-y-4">
                                <div className={`p-4 rounded-lg ${isDarkMode ? "bg-gray-700" : "bg-gray-50"}`}>
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            <p className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>Event Type</p>
                                            <p className={`font-medium ${isDarkMode ? "text-white" : "text-gray-900"}`}>{previewResource.eventCategory}</p>
                                        </div>
                                        <div>
                                            <p className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>Date & Time</p>
                                            <p className={`font-medium ${isDarkMode ? "text-white" : "text-gray-900"}`}>
                                                {new Date(previewResource.eventDate || "").toLocaleDateString()} {previewResource.eventTime}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div className={`prose max-w-none ${isDarkMode ? "prose-invert" : ""}`}>{previewResource.shortDescription}</div>
                            </div>
                        ) : (
                            // Article Content with SEO Metadata at bottom
                            <>
                                {/* Article Content */}
                                <div className={`prose max-w-none mb-8 ${isDarkMode ? "prose-invert" : ""}`}>
                                    <div
                                ...
                                <div className={`p-4 rounded-lg ${isDarkMode ? "bg-gray-700" : "bg-gray-50"}`}>
                                    <h3 className={`text-lg font-semibold mb-4 ${isDarkMode ? "text-white" : "text-gray-900"}`}>SEO Metadata</h3>
                                    <div className="space-y-3">
                                        <div>
                                            <p className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>Meta Title</p>
                                            <p className={`font-medium ${isDarkMode ? "text-white" : "text-gray-900"}`}>{previewResource.seoMetadata.title}</p>
                                        </div>
                                        <div>
                                            <p className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>Meta Description</p>
                                            <p className={`font-medium ${isDarkMode ? "text-white" : "text-gray-900"}`}>{previewResource.seoMetadata.description}</p>
                                        </div>
                                        <div>
                                            <p className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>Keywords</p>
                                            <div className="flex flex-wrap gap-2">
                                                {previewResource.seoMetadata.keywords.split(",").map((keyword, index) => (
                                                    <span
                                                        key={index}
                                                        className={`px-2 py-1 text-sm rounded-full ${isDarkMode ? "bg-gray-600 text-gray-200" : "bg-gray-200 text-gray-700"}`}
                                                    >
                                                        {keyword.trim()}
                                                    </span>
                                                ))}
            ...
            {isDeleteModalOpen && (
                <div className="fixed inset-0 backdrop-blur-sm bg-black/30 flex items-center justify-center z-50">
                    <div
                        className={`${isDarkMode ? "bg-gray-800/95" : "bg-white/95"} rounded-lg p-6 w-full max-w-md relative shadow-xl backdrop-blur-sm border ${
                            isDarkMode ? "border-gray-700" : "border-gray-200"
                        }`}
                    >
                        {/* Modal Header */}
                        <div className="flex justify-between items-center mb-6">
                            <h2 className={`text-2xl font-semibold ${isDarkMode ? "text-white" : "text-gray-900"}`}>Delete Resource</h2>
                            <button
